...
import com.meerkatgramv2auth.global.errors.custom.business.FileManagedException;
      ...
      minioClient
          .putObject(
              PutObjectArgs.builder()
                  ...
                  .stream(
                      inputStream,                    // 업로드 할 파일의 InputStream
                      file.getSize(),                 // 업로드 할 파일의 크기
                      -1                              // 업로드 시 패킷 크기(-1은 Minio SDK가 적절하게 조절해서 전송)
                  )
